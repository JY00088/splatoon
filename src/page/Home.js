          ...
          <div className="List01">
            ...
            <section className="Lvideo03">
              ...
              <div className="rot">
                <picture>
                  <source />
                  <img className="t03" src="img/back/bg_ink.png" />
                </picture>
              </div>
              <Sliderbox />
            </section>
          ...
          <div className="List03">
            <div className="List03back">
              <article className="listfront">
                <div className="frontink">
                  <picture>
                    <source />
                    <img className="foink1" src="/img/back/ink06.png" />
                  </picture>
                  <picture>
                    <source />
                    <img className="foink2" src="/img/back/ink10.png" />
                  </picture>
                  <picture>
                    <source />
                    <img className="foink3" src="/img/back/ink06.png" />
                  </picture>
                  <picture>
                    <source />
                    <img className="foink4" src="/img/back/ink11.png" />
                  </picture>
                  <picture>
                    <source />
                    <img className="foink5" src="/img/back/ink01.png" />
                  </picture>
                </div>
              ...
              <article className="listback">
                ...
                <div className="inkrgb">
                  <picture>
                    <source />
                    <img className="in1" src="/img/back/ink01.png" />
                  </picture>
                  <picture>
                    <source />
                    <img className="in2" src="/img/back/ink01.png" />
                  </picture>
                  <picture>
                    <source />
                    <img className="in3" src="/img/back/ink13.png" />
                  </picture>
                  <picture>
                    <source />
                    <img className="in4" src="/img/back/ink12.png" />
                  </picture>
                </div>
              </article>
            </div>
